...
const CreateTestItem: React.FC<{}> = () => {
  ...
  const editBriefOnOk = (searchInfo: { [key: string]: string }) => {
    editBrief(searchInfo);
  ...
  const durationTimeOnOk = (searchInfo: { [key: string]: string }) => {
    editDurationTime(searchInfo);
  ...
  const equipmentOnOk = (searchInfo: { [key: string]: string }) => {
    editEquipment(searchInfo);
